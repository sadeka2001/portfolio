...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="{{ $main->bg_image }}" alt="" class="img-fluid rounded-circle">
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center"
        style="background-image:url(<?php echo $main->bg_image; ?>)">
        <div class="hero-container" data-aos="fade-in">
            <h1>{{ $main->tittle }}</h1>
            <p>I'm <span class="typed" data-typed-items="{{ $main->sub_tittle }}"></span></p>
        </div>
    </section><!-- End Hero -->
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-up">
                        ...
                        <div class="resume-item">
                            ...
                            <h5>2018 - 2019</h5>
                            <p><em>Coxsbazar Govt women collage, coxsbazar</em></p>
                            <p>I have completed my hsc from Cox'sbazar govt women collage with gpa 3.83.</p>
                        </div>
                        <div class="resume-item">
                            <h4>Bachelor of Science </h4>
                            <h5>2020 - 2023</h5>
                            <p><em>Dhaka International University</em></p>
                            <p>Now, i'm study in private university with cgpa 3.8 .</p>
                        </div>
                    </div>
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="resume-item">
                            <h4>web developer</h4>
                            <h5>2023 - Present</h5>
                            <p><em>Experion, pnt, Dhaka</em></p>
                            <ul>
                                <li>Internship at PeopleNtech Limited,Dhaka</li>
                        ...
                        <div class="resume-item">
                            ...
                            <p><em>Dhaka</em></p>
                            <ul>
                                <li>Completed SEIP graphic course from peopleNtech.</li>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Panthapath, East Razabazar, Dhaka-1205</p>
                            </div>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">sadeka akther</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
