                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="date" name="date" value="{{$portfolio->date}}">
                         </div>
                         ...
                         <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="url" name="url" value="{{$portfolio->url }}">
                         </div>
                         <div class="mb-3">
                            <label for="tittle">
                                <h5>Tittle</h5>
                         ...
                         <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="description" name="description" value="{{$portfolio->description}}">
                         </div>

                         <div class="form-group col-md-3 mt-3">
                            <h4>Big image</h4>
                            <div class="form-group col-md-4 mt-3">
                                <img style="height:100px" src="{{url('uploads/portfolio_project/'.$portfolio->bg_image)}}" alt="">
                        ...
                        <div class="form-group col-md-3 mt-3">
                            <h4>small image</h4>
                            <div class="form-group col-md-4 mt-3">
                                <img style="height:100px" src="{{url('uploads/portfolio_project/'.$portfolio->sm_image)}}" alt="">
